...
DATASETS_INFO = {
    'isic16': {
        "urls": ("https://isic-challenge-data.s3.amazonaws.com/2016/ISBI2016_ISIC_Part3B_Training_Data.zip",
    ...
    'isic17': {
        "urls": ("https://isic-challenge-data.s3.amazonaws.com/2017/ISIC-2017_Training_Data.zip",
    ...
    'isic18': {
        "urls": ("https://isic-challenge-data.s3.amazonaws.com/2018/ISIC2018_Task1-2_Training_Input.zip",
    ...
    'isic19': {
        "urls": ("https://isic-challenge-data.s3.amazonaws.com/2019/ISIC_2019_Training_Input.zip",
    ...
    # isic20 provides links of JPEG images, not DICOM
    'isic20': {
        "urls": ("https://isic-challenge-data.s3.amazonaws.com/2020/ISIC_2020_Training_JPEG.zip",
    ...
    'mclass': {
        "urls": ("https://skinclass.de/MClass/MClass-D.zip",
    ...
    'padufes': {
        "urls": ("https://prod-dcd-datasets-cache-zipfiles.s3.eu-west-1.amazonaws.com/zr7vgbcyr2-1.zip",
                 )
    },
    'mednode': {
    ...
    'spc': {
        "urls": ("https://derm.cs.sfu.ca/restricted/release_v0.zip",
                 ),
        "credentials": os.environ.get("SPC_CREDENTIALS", (None, None))
    },
    'ph2': {
        "urls": ("https://www.dropbox.com/s/k88qukc20ljnbuo/PH2Dataset.rar",
                 )
    }
}
